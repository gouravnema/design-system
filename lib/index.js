...
import { faChevronDown, faClose, faPhone } from "@fortawesome/free-solid-svg-icons";
...
export { Avatar, COLORS, Card, DateFormatter, DoughnutChart, Form, H1, H4, Modal, ParsedText, PrimaryPill, RADIUS, SHADOW, SIZES, SecondaryPill, SideNav, Silhouette, Sprite, Switch, TYPOGRAPHGY, Text, TextInput, TimeFormatter, TopNavigation, TransparentPill, Version, WEIGHTS, ZINDEX };
