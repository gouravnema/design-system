...
const SwitchContainer = styled_components.button`
    ...
    min-width: 13px;
    min-height: 8px;
    background-color: ${(props)=>props.isActive ? COLORS.green : COLORS.base};
    border: none;
    border-radius: 50vh;
    cursor: pointer;
    ...
    outline: none;
    box-sizing: border-box;
    box-shadow: ${(props)=>props.isActive ? SHADOW.medium : SHADOW.insetLight};

    &:hover {
        box-shadow: ${(props)=>props.isActive ? SHADOW.large : SHADOW.insetMedium};
    }
